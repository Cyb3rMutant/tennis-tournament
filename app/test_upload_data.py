...
import os
test_files_0 = os.listdir('app/data_app/endpoint4/test0_correct')
...
test_files_1 = os.listdir('app/data_app/endpoint4/test1_normal')
...
test_files_2 = os.listdir('app/data_app/endpoint4/test2')
...
test_files_3 = os.listdir('app/data_app/endpoint4/test3')
...
test_files_4 = os.listdir('app/data_app/endpoint4/test4')
...
test_files_5 = os.listdir('app/data_app/endpoint4/test5')
...
test_files_6 = os.listdir('app/data_app/endpoint4/test6')
